...
public class RoomLightListAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public RoomLightListAdapter(@NonNull Activity context, RoomGroupDetailsClass groupDetailsClass, EditGroupRoomFragment editDeviceFragment) {
        activity = context;
...
//        arrayList.get(selectedPosition).setStatus();
        ...
        if(AppHelper.IS_TESTING)
        {
            ...
            contentValues.put(COLUMN_GROUP_ROOMID, groupDetailsClass.getRoomGroupId());
...
//            animatedProgress.showProgress();
        ...
        builder.setMessage("Are you sure to add "+deviceClass.getDeviceName()+" to group "+groupDetailsClass.getGroupRoomName())
