...
public class IndividualSwitchAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualSwitchAdapter(@NonNull Activity context) {
        activity = context;
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualSwitchAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualSwitchAdapter.this.seekBarProgress=seekBarProgress[0];
