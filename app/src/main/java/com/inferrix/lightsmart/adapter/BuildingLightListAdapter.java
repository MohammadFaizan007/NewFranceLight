...
public class BuildingLightListAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public BuildingLightListAdapter(@NonNull Activity context, BuildingGroupDetailsClass groupDetailsClass, EditGroupBuildingFragment editDeviceFragment) {
        activity = context;
...
//        arrayList.get(selectedPosition).setStatus();
        ...
        if(AppHelper.IS_TESTING)
        {
            ...
            contentValues.put(COLUMN_GROUP_BUILDINGID, groupDetailsClass.getGroupBuildingId());
...
//            animatedProgress.showProgress();
        ...
        builder.setMessage("Are you sure to add "+deviceClass.getDeviceName()+" to group "+groupDetailsClass.getGroupBuildingName())
...
//            acceptRequest(2,position);
            ...
            byteQueue.push(RxMethodType.ADD_BUILDING_GROUP);
            byteQueue.push(0x01);
