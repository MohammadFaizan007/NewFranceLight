...
public class RoomAdapter extends BaseAdapter implements Filterable, AdvertiseResultInterface, ReceiverResultInterface {
    ...
    private RoomAdapter.ItemFilter mFilter = new RoomAdapter.ItemFilter();
    public RoomAdapter(@NonNull Activity context) {
        activity = context;
    ...
    public void setList(List<RoomGroupDetailsClass> arrayList1) {
        arrayList.clear();
...
//    }
    ...
    public void showDialog(int index)
    {
        ...
        RoomGroupDetailsClass groupDetails =arrayList.get(index);
