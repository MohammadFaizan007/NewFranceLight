...
import static com.inferrix.lightsmart.ServiceModule.ScanningBeacon.bytesToHex;

public class IndividualPirSwitchAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualPirSwitchAdapter(@NonNull Activity context) {
        activity = context;
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualPirSwitchAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualPirSwitchAdapter.this.seekBarProgress=seekBarProgress[0];
