...
public class LevelLightListAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public LevelLightListAdapter(@NonNull Activity context, LevelGroupDetailsClass groupDetailsClass, EditGroupLevelFragment editDeviceFragment) {
        activity = context;
...
//        arrayList.get(selectedPosition).setStatus();
        ...
        if(AppHelper.IS_TESTING)
        {
            ...
            contentValues.put(COLUMN_GROUP_LEVELID, groupDetailsClass.getGroupLevelId());
...
//            animatedProgress.showProgress();
        ...
        builder.setMessage("Are you sure to add "+deviceClass.getDeviceName()+" to group "+groupDetailsClass.getGroupLevelName())
...
//            acceptRequest(2,position);
            ...
            byteQueue.push(RxMethodType.ADD_LEVEL_GROUP);
            byteQueue.push(0x01);
