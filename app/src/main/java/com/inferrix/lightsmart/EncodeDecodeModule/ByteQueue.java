...
public class ByteQueue implements Cloneable {
    ...
    public void pushLSBU2B(int i) {
        push((byte) (255 & i));
        push((byte) (255 & i >> 8));
    }

    public void pushLSBU3B(int i) {
        push((byte) (255 & i));
        push((byte) (255 & i >> 8));
        push((byte) (255 & i >> 16));
    }

    public void pushLSBU4B(long l) {
        push((byte) (255 & l));
        push((byte) (255 & l >> 8));
        push((byte) (255 & l >> 16));
        push((byte) (255 & l >> 24));
    ...
    public short popLSBS2B() {
        return (short) ((pop() & 0xff) | ((pop() & 0xff) << 8));
    }

    public int popLSBU1B() {
        return pop() & 255;
    }

    public int popLSBU2B() {
        return pop() & 255 | (pop() & 255) << 8;
    }

    public int popLSBU3B() {
        return (pop() & 255) | (pop() & 255) << 8 | pop() & 255 << 16;
    }

    public long popLSBU4B() {
        return (long)pop() & 255 | (long)(pop() & 255) << 8 | (long)(pop() & 255) << 16 | (long)((pop() & 255) << 24);
    }
    ...
    public int peekLSBU1B() {
        return peek(0) & 255;
    }

    public int peekLSBU2B() {
        return peek(0) & 255 | (peek(1) & 255) << 8;
    }
