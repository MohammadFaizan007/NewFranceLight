...
//    public static final String COLUMN_DEVICE_TAG_NUMBER = "DEVICE_TAG";
    ...
    public static final String CREATE_DEVICE_TABLE = "CREATE TABLE IF NOT EXISTS " +
            ADD_DEVICE_TABLE + "(" + COLUMN_DEVICE_UID +
            " INTEGER PRIMARY KEY ," + COLUMN_DEVICE_STATUS +
            " INTEGER DEFAULT 1 ," + COLUMN_DEVICE_MASTER_STATUS +
            " INTEGER DEFAULT 0 ," + COLUMN_DEVICE_PROGRESS + " INTEGER DEFAULT 100 ," +
